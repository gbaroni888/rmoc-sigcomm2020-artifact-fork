...
mkdir -p OutputDataSets/Rocketfuel/AS3967/WidthHops/WidestLeastHopsOrder
...
./Simulator/Executables/SimulateNonRestartingProtocol -n Rocketfuel/AS3967/WidthHops     	-o WidestLeastHopsOrder         -r 3
